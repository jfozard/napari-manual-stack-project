import napari_manual_stack_project
import pytest

# this is your plugin name declared in your napari.plugins entry point
MY_PLUGIN_NAME = "napari-manual-stack-project"
...
def test_something_with_viewer(widget_name, make_napari_viewer, napari_plugin_manager):
    napari_plugin_manager.register(napari_manual_stack_project, name=MY_PLUGIN_NAME)
